...
export class GiftboxService {
  ...
  static async updateGiftbox(giftboxId, giftboxName, giftboxDescription, noteContent, giftboxPrice) { //meka my giftbox krnna...otherwise patalenw
    ...
    try {
      ...
      return await connection
        .promise()
        .query(query, [giftboxName, giftboxDescription, noteContent, giftboxPrice, giftboxId]);
    } catch (error) {
      console.error('Error updating giftbox:', error);
      throw error;
    }

...
const EditGiftbox = ({ closeEvent, open, giftboxID, giftbox }) => {
  ...
  const handleInputChange = (event, field) => {
    setGiftboxData({ ...giftboxData, [field]: event.target.value });
  };

  const handleAccessoryChange = (index, field, value) => {
    const updatedAccessories = [...giftboxData.accessories];
    updatedAccessories[index][field] = value;
    setGiftboxData({ ...giftboxData, accessories: updatedAccessories });
  };
  ...
  const handleRemoveAccessory = (index) => {
    const updatedAccessories = giftboxData.accessories.filter((_, i) => i !== index);
    setGiftboxData({ ...giftboxData, accessories: updatedAccessories });
  };

...
//   const deleteCategory = async (categoryID) => {
//     try {
//       // Check if there are any accessories under the category
//       const responseCheck = await fetch(`http://localhost:3001/api/accessory/getAccessoriesByCategory/${categoryID}`);
//       if (!responseCheck.ok) {
//         throw new Error("Failed to fetch accessories for the category");
//       }
//       const accessories = await responseCheck.json();

//       if (accessories.length > 0) {
//         Swal.fire("Error!", "Category cannot be deleted because it has associated accessories.", "error");
//         return;
//       }
...
//         <Box height={30} />
//         <Grid item xs={12}>
//           <Card sx={{ height: "150vh", flexGrow: 1 }}>
//             <div
//               style={{
//                 display: "flex",
//                 justifyContent: "space-between",

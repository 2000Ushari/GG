...
//This includes the accessory card with the specific details and the edit button and delete button
//This retrieves the data from the accessory table of the database and displays it in a card
//( kinda works as a loop )
...
//         "http://localhost:3001/api/employee/getEmployee"
//       );
//       if (!response.ok) {
...
//                   closeEvent={handleCloseAddEmployeeModal}
//                 />
//               </Stack>
//             </div>
//             <div
...
const EmployeeList = () => {
  ...
  const fetchEmployees = async () => {
    try {
      const response = await fetch('http://localhost:3001/api/employee/getEmployee');
      if (!response.ok) {
        throw new Error('Failed to fetch employees');
      }

    ...
    const fetchEmployee = async () => {
      try {
        const response = await fetch(
          `http://localhost:3001/api/employee/getEmployeeById/${employeeId}`
        );
    ...
    <div className="bgcolor">
        ...
        <Box sx={{ display: "flex" }}>
          ...
          <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
            ...
            <Typography gutterBottom variant="h5" component="div" sx={{ marginLeft: "10px", fontWeight: "bold", pb: 2 }}>
             Employee Details
            </Typography>
            </Box>
            <br/>

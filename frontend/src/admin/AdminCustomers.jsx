...
function AdminCustomers() {
  ...
  const fetchCustomers = async () => {
    try {
      const response = await fetch('http://localhost:3001/api/customer/getCustomers');
      if (!response.ok) {
  ...
  return (
    <>
      <div>AdminCustomers ratings feedbacks complaints customer details - view</div>
            ...
            <Card>
              ...
              <Grid item xs={12}>
                <Card sx={{ pb: 2, flexGrow: 1 }}>
                  ...
                  <Button>
                    <CustomerList>list of customers</CustomerList>
                  </Button>
                  <div
                    style={{
                      display: 'flex',

    ...
    <div>
      <Grid item xs={12}>
        <Stack spacing={2} direction={'row'}>
          <Card sx={{ minWidth: 24 + '%', height: 200 }} className="gradientbluish">
            <CardContent>
          ...
          <Card sx={{ minWidth: 24 + '%', height: 200 }} className="gradientgreenish">
            <CardContent>
              <div className="iconstyle">
                <FaceIcon />
              </div>
          ...
          <Card sx={{ minWidth: 24 + '%', height: 200 }} className="gradientyellowish">
            <CardContent>
              <div className="iconstyle">
                <InventoryIcon />
              </div>
          ...
          <Card sx={{ minWidth: 24 + '%', height: 200 }} className="gradientpurpleish">
            <CardContent>
              <div className="iconstyle">
                <ShoppingBagIcon />
              </div>

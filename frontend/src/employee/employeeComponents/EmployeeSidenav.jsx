    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <List>
          ...
          <ListItem disablePadding sx={{ display: 'block' }} onClick={() => navigate('/employee/order')}>
            <ListItemButton
              sx={{
                minHeight: 48,
                justifyContent: open ? 'initial' : 'center',
          ...
          <ListItem disablePadding sx={{ display: 'block' }} onClick={() => navigate('/employee/categories')}>
            <ListItemButton
              sx={{
                minHeight: 48,
                justifyContent: open ? 'initial' : 'center',
          ...
          <ListItem disablePadding sx={{ display: 'block' }} onClick={() => navigate('/employee/accessories')}>
            <ListItemButton
              sx={{
                minHeight: 48,
                justifyContent: open ? 'initial' : 'center',
          ...
          <ListItem disablePadding sx={{ display: 'block' }} onClick={() => navigate('/employee/giftboxes')}>
            <ListItemButton
              sx={{
                minHeight: 48,
                justifyContent: open ? 'initial' : 'center',

  ...
  return (
    <div>
      <Accordion>
        ...
        <AccordionDetails>
          <Typography>Ratings wadima accessory ek</Typography>
        </AccordionDetails>
      </Accordion>
      <Accordion>
        ...
        <AccordionDetails>
          <Typography>\orders wadima ekkena</Typography>
        </AccordionDetails>
      </Accordion>
      ...
      <Accordion>
        ...
        <AccordionDetails>
          <Typography>most sold gb ek</Typography>
        </AccordionDetails>
      </Accordion>
      <Accordion>
        <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls="panel2-content" id="panel2-header">
        ...
        <AccordionDetails>
          <Typography>Overall service rate ek</Typography>
        </AccordionDetails>
      </Accordion>
    </div>
  );

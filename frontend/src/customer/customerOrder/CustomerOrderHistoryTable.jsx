...
export default function CustomerOrderHistoryTable( closeEvent) {
  ...
  useEffect(() => {
    ...
    const fetchOrders = async () => {
      try {
        const response = await axios.get(`http://localhost:3001/api/order/getOrderHistoryByCustomerId/${customerId}`);

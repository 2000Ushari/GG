    ...
    <Box sx={{ display: "flex" }}>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <List>
          ...
          <ListItem disablePadding sx={{ display: "block" }} onClick={() => navigate("/customer/ourProducts")}>
            <ListItemButton
              sx={{
                minHeight: 48,
                justifyContent: open ? "initial" : "center",
          ...
          <ListItem disablePadding sx={{ display: "block" }} onClick={() => navigate("/customer/giftboxes")}>
            <ListItemButton
              sx={{
                minHeight: 48,
                justifyContent: open ? "initial" : "center",
          ...
          <ListItem disablePadding sx={{ display: "block" }} onClick={() => navigate("/customer/cart")}>
            <ListItemButton
              sx={{
                minHeight: 48,
                justifyContent: open ? "initial" : "center",
          ...
          <ListItem disablePadding sx={{ display: "block" }}  onClick={() => navigate("/customer/orders")}>
            <ListItemButton
              sx={{
                minHeight: 48,
                justifyContent: open ? "initial" : "center",
          ...
          <ListItem disablePadding sx={{ display: "block" }} onClick={() => navigate("/customer/favorites")}>
            <ListItemButton
              sx={{
                minHeight: 48,
                justifyContent: open ? "initial" : "center",
          ...
          <ListItem disablePadding sx={{ display: "block" }} onClick={() => navigate("/customer/settings")}>
            <ListItemButton
              sx={{
                minHeight: 48,
                justifyContent: open ? "initial" : "center",

...
function AccessoryCard({ accessoryDetails }) { // Pass customerId as a prop
  const [value, setValue] = React.useState(accessoryDetails.rating || 4); // Assuming rating is provided in accessoryDetails
  const label = { inputProps: { 'aria-label': 'Checkbox demo' } };
  ...
  //       // Make API request to add accessory to favorites
  //       await axios.post(`http://localhost:3001/api/accessory/addToFavorites/${customerId}/${accessoryDetails.accessoryId}`, {

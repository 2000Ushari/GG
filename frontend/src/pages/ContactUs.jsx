...
export default function ContactUs() {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        'For all GlitterGallery products, the order deadline is one day prior to the delivery date. If the order is needed within three days or less, an additional 20% of the order amount will be charged. Orders can only be canceled one week prior to the order delivery date.',
    },
    {
              ...
              <Card sx={{ p: 3, height: '100%' }}>
                <CardContent>
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                    ...
                    <Typography variant="body1">No. 123, Galle Road, Colombo 03, Sri Lanka</Typography>
                  </Box>
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                    <PhoneIcon sx={{ mr: 1 }} />
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                    <EmailIcon sx={{ mr: 1 }} />
                    <Typography variant="body1">support@giftboxgallery.com</Typography>
                  </Box>

...
const testimonials = [
  {
    ...
    comment:
      'The gift box I ordered from The Glitter Gallery was absolutely stunning! It arrived on time and made my sister’s birthday extra special. Thank you for the beautiful presentation and excellent service!',
    rating: 5,
  ...
  },
  {
    ...
    comment:
      'I was amazed by the detail and care put into the packaging. The items were high quality and the recipient loved every bit of it. Highly recommended!',
    rating: 5,
  ...
  },
  {
    ...
    comment:
      'The service was fast, friendly, and the gift box was better than I expected. Will definitely order again. Thank you Glitter Gallery!',
    rating: 5,
